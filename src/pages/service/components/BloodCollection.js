    ...
    return(
        <div className={styles.container}>
            <div className={styles.section}>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_title}>채혈지침</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.text_normal_500}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.sub_wrapper}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_title}>채혈절차</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_num_wrapper}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_title}>올바른 채혈 방법</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.sub_wrapper}>
                    <div className={styles.sub_title_wrapper}>
                        <div className={styles.rect}/>
...
④ 일반혈관의 경우 채혈관에 혈류가 유입되기 시작하면 곧바로 지혈대를 풀고 환자의 주먹을 펴도록 한다.  <br/>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.mixing_title}>Mixing / 믹싱</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.mixing_content_wrapper}>
                ...
                <div className={styles.mobile_none}>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_title + " " + styles.mg_lft_50}>검체 채취용 용기 종류 및 혼합 방법</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_title + " " + styles.mg_lft_50}>검체채취과정</div>
                <img data-aos="fade-up"  data-aos-duration="2000" src="../imgs/img/extraction.png" alt="" className={styles.extraction_img}/>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.extraction_last_wrapper}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.section_title + " " + styles.mg_lft_50}>검체 분리 및 보관</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.text_light + " " + styles.mg_lft_50}>
