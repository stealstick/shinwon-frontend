    ...
    return(
        <div className={styles.container}>
            ...
            <div className={styles.img_wrapper}>
                <img src="/imgs/icons/icon-left.svg" alt="" className={styles.icon} onClick={() => setIsFirst(!isFirst)}/>
                {isFirst ? 
                <>
                ...
                <img src="/imgs/icons/icon-right.svg" alt="" className={styles.icon} onClick={() => setIsFirst(!isFirst)}/>
            </div>
        </div>
    )
}
