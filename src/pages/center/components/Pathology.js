...
const Pathology = () => {
    ...
    return(
        <div class="body-content-sticky">
            <div data-aos="fade-up"  data-aos-duration="2000" class="content-title-wrapper">
                <div class="content-title-kor">병리학부</div>
                <div class="content-title-eng">PATHOLOGY CENTER</div>
            </div>
            <div data-aos="fade-up"  data-aos-duration="2000" class="pathology-intro">
                신원의료재단 병리과는 환자의 병변 부위에서 채취하는 조직, 체액, 세포검체를 신속 정확하게 검사하여<br/>
                치료와 예후 측정에 필요한 정보를 전문 의료인에게 제공하여 환자의 치료 방침에 기여하려 최선을 다하고 있습니다.
            </div>
            <div data-aos="fade-up"  data-aos-duration="2000" class="pathology-test-info">
            ...
            <div class="equipment-wrapper">
                <div data-aos="fade-up"  data-aos-duration="2000" class="equipment-title">병리과 장비안내</div>
                <div data-aos="fade-up"  data-aos-duration="2000" class="equipment-content">
