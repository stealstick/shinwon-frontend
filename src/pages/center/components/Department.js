    ...
    const ContentFirst = () => {
        return(
            <div className="transform-div first">
                <div data-aos="fade-up"  data-aos-duration="2000" className="department-name">
                    <img src="../imgs/img/gene.svg" alt="" className="department-icon"/>
                    <div className="department-title-text">임상화학부</div>
                </div>
                <div data-aos="fade-up"  data-aos-duration="2000" className="intro">
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className="task-wrapper">
                ...
                <div className="equipment-wrapper">
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-title">임상화학부 장비안내</div>
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-content">
    ...
    const ContentSecond = () => {
        return(
            <div className="transform-div second hidden">
                ...
                <div className="equipment-wrapper">
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-title">진단면역학부 장비안내</div>
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-content">
                        <div className="equipment-desc">
    ...
    const ContentThird = () => {
        return(
            <div className="transform-div third hidden">
                ...
                <div className="equipment-wrapper">
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-title">진단혈액학부 장비안내</div>
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-content">
                        <div className="equipment-desc">
    ...
    const ContentFourth = () => {
        return(
            <div className="transform-div fourth hidden">
                ...
                <div className="equipment-wrapper">
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-title">임상미생물학부 장비안내</div>
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-content">
                        <div className="equipment-desc">
    ...
    const ContentFifth = () => {
        return(
            <div className="transform-div fifth hidden">
                ...
                <div className="equipment-wrapper">
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-title">요검경학부 장비안내</div>
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-content">
                        <div className="equipment-desc">
    ...
    const ContentSixth = () => {
        return(
            <div className="transform-div sixth hidden">
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className="textbox-wrapper">
                ...
                <div className="equipment-wrapper">
                    <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-title">분자유전학부 장비안내</div>
                    <div className="equipment-content-2">
                        <div data-aos="fade-up"  data-aos-duration="2000" className="equipment-desc-2">
