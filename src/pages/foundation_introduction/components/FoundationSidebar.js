...
const FoundationSidebar = ({ selectedNum}) => {
    return(
        ...
        <div className={styles.sidebar}>
            ...
            <Link to="/foundation/3" className={selectedNum===3 ? styles.sidebar_selected : styles.sidebar_content}>조직도</Link>
            <Link to="/foundation/4" className={selectedNum===4 ? styles.sidebar_selected : styles.sidebar_content}>재단연혁</Link>
