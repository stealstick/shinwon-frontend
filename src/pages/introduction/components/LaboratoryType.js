...
const LaboratoryType = () => {
    ...
    const Serum = () => {
        return(
            <div className={styles.section}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.text_normal_500}>Serum을 이용하는 검사</div>
    ...
    const WholeBlood = () => {
        return(
            <div className={styles.section}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.text_normal_500}>Whole Blood(전혈)을 이용하는 검사</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.type_content_wrapper}>
    ...
    const MetabolicAbnormality = () => {
        return(
            <div className={styles.section}>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.type_content_title_wrapper_kor}>선천성 대사이상</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.type_content_wrapper}>
    ...
    const FetalIdealism = () => {
        return(
            <div className={styles.section}>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.type_content_title_wrapper_kor}>산전 태아 이상성별</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.type_content_wrapper}>
    ...
    const VirusCulture = () => {
        return(
            <div className={styles.section}>
                ...
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.text_normal_500}>바이러스 감염 시 원인 바이러스를 검출하는 방법은 일반세균의 검출방법과는 다소 차이가 있습니다.</div>
                <div data-aos="fade-up"  data-aos-duration="2000" className={styles.type_content_wrapper}>
                ...
                <img data-aos="fade-up"  data-aos-duration="2000" src="/../imgs/img/virusculture.png" alt="" className={styles.img}/>
            </div>
        )
    }
